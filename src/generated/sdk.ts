...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    ): Promise<GetCarteQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetCarteQuery>(GetCarteDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getCarte'
    ...
    getEtapes(
      variables?: GetEtapesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetEtapesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetEtapesQuery>(GetEtapesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getEtapes'
